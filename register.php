...
<?php include "header-sup.php"; ?>
    <section class="register">
        <h3><?php echo get_post_meta($post->ID, 'Please_Register', true) ?></h3>
        <form class="needs-validation" novalidate>
            <div class="form-row form-input">
                <div class="col-12 col-sm-12 my-group">
                    ...
                    <label class="input-label" for="validationCustom01"><?php echo get_post_meta($post->ID, 'First', true) ?></label>
                    <div class="invalid-feedback">
                        <span><img src="./img/svg/Warning.svg" alt=""><?php echo get_post_meta($post->ID, 'first-wn', true) ?></span>
                    </div>
                </div>
                <div class="col-12 col-sm-12 my-group">
                    <input type="text" class="form-control" id="validationCustom02" placeholder="your last name" required>
                    <label class="input-label" for="validationCustom02"><?php echo get_post_meta($post->ID, 'Last', true) ?></label>
                    <div class="invalid-feedback">
                        <span><img src="./img/svg/Warning.svg" alt=""><?php echo get_post_meta($post->ID, 'last-wn', true) ?></span>
                    </div>
                </div>
                <div class="col-12 col-sm-12 my-group">
                ...
                <div class="col-12 col-sm-12 my-group">
                    ...
                    <label class="input-label" for="password2"><?php echo get_post_meta($post->ID, 'Confirm', true) ?></label>
                    
                    <div class="invalid-feedback">
                        <span><img src="./img/svg/Warning.svg" alt=""><?php echo get_post_meta($post->ID, 'confirm-wn', true) ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-row form-btn">
                <div class="col-6 col-sm-6">
                    <button class="btn btn-already" type="button"><?php echo get_post_meta($post->ID, 'Already', true) ?></button>
                </div>
                <div class="col-6 col-sm-6">
                    <button class="btn btn-sign-up" type="submit"><?php echo get_post_meta($post->ID, 'Sign-up', true) ?><img src="./img/svg/tail-right.svg" alt=""></button>
                </div>
            </div>
        </form>
    </section>   
